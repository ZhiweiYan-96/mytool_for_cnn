...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        self.sp_attend0 = SpatialAttentionLayer(512)
        self.sp_attend1 = SpatialAttentionLayer(512)
        self.sp_attend2 = SpatialAttentionLayer(512)
        ...
        self.sp_attend3 = SpatialAttentionLayer(1024)
        self.sp_attend4 = SpatialAttentionLayer(1024)
        self.sp_attend5 = SpatialAttentionLayer(1024)
        ...
        self.sp_attend6 = SpatialAttentionLayer(512)
        self.sp_attend7 = SpatialAttentionLayer(512)
        self.sp_attend8 = SpatialAttentionLayer(512)
        ...
        self.sp_attend9 = SpatialAttentionLayer(256)
        self.sp_attend10 = SpatialAttentionLayer(256)
        self.sp_attend11 = SpatialAttentionLayer(256)
        ...
        self.sp_attend12 = SpatialAttentionLayer(256)
        self.sp_attend13 = SpatialAttentionLayer(256)
        self.sp_attend14 = SpatialAttentionLayer(256)
