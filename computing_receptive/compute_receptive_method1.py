...
net_struct1= {
                ...
                'ssd_300':{
                    'net':[ [3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[3,1,1],[3,1,1],[2,2,0],
                            [3,1,6], [1,1,0],[1,1,0],[3,2,1],[1,1,0],[3,2,1],[1,1,0],[3,1,0],[1,1,0],[3,1,0]],
                    'name':['conv1_1','conv1_2','pool1',
                            'conv2_1','conv2_2','pool2',
                            'conv3_1','conv3_2','conv3_3','pool3',
                            'conv4_1','conv4_2','conv4_3','pool4',
                            'conv5_1','conv5_2','conv5_3','pool5',
                            'fc6','fc7','conv6_1','conv6_2','conv7_1','conv7_2','conv8_1','conv8_2','conv9_1','conv9_2']
                },
                
                'ssd_300_spfusion_biway':{
                    'net':[ [3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[3,1,1],[2,2,0],
                            [3,1,1],[1,1,0],[1,1,0],[3,2,1],
                            [1,1,0],[1,1,0],[1,1,0],[3,2,1],
                            [3,1,1],[3,1,1],[3,1,1],[2,2,0],
                            [3,1,6], [1,1,0],[1,1,0],[3,2,1],[1,1,0],[3,2,1],[1,1,0],[3,1,0],[1,1,0],[3,1,0]],
                    'name':['conv1_1','conv1_2','pool1',
                            'conv2_1','conv2_2','pool2',
